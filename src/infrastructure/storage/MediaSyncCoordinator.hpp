...
private:
    [[nodiscard]] static Snapshot pushWithConflictResolution(const Snapshot& local, CloudStorageClient& cloudClient, std::optional<std::chrono::system_clock::time_point> baseline);
